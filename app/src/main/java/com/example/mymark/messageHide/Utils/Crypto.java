package com.example.mymark.messageHide.Utils;
...
public class Crypto {
    ...
    public static String encryptMessage(String message, String secret_key) throws Exception {
        ...
        // encrypt the com.example.mymark.messageHide.text
    ...
    public static String decryptMessage(String encrypted_message, String secret_key) throws Exception {
        ...
        // decrypting the com.example.mymark.messageHide.text
        ...
        //returning decrypted com.example.mymark.messageHide.text
        return decrypted;
    }
